...
public class SwipeAdapterparages extends FragmentStatePagerAdapter {
    private MiGranja miGranja;
    private int tipoanimal;
    private ArrayList<Animal> animales;

    public SwipeAdapterparages(FragmentManager fr) {
        super(fr);
        miGranja = null;
        tipoanimal = -1;
        animales = null;
    ...
    public SwipeAdapterparages(FragmentManager fr, MiGranja miGranja, int tipoanimal) {
        super(fr);
    ...
    public Fragment getItem(int position) {
        FragmentPageparages pageFragment = new FragmentPageparages();
