...
public class visualizaranimales extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_visualizaranimales);
        Intent i = getIntent();
        ...
        SwipeAdapter swipeAdapter = new SwipeAdapter(getSupportFragmentManager(), miGranja, tipoanimal);
    ...
    public static Intent getCallingIntent(Context context, MiGranja miGranja, int tipoanimal){
        ...
        Intent intent = new Intent(context, visualizaranimales.class );
