...
public class seleccionanimaldarbaja extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seleccionanimaldarbaja);
        Intent i = getIntent();
    ...
    public void abrirvaca (View w){
        startActivity(visualizaranimalesengestacion.getCallingIntent(this, miGranja,0,1));
    }

    public void abrircerdo (View w){
        startActivity(visualizaranimalesengestacion.getCallingIntent(this, miGranja,1,1));
    }

    public void abriroveja (View w){
        startActivity(visualizaranimalesengestacion.getCallingIntent(this, miGranja,3,1));
    }

    public void abrirgallina (View w) {
        startActivity(visualizaranimalesengestacion.getCallingIntent(this, miGranja,2,1));
    }

    public void abrircabra (View w){
        startActivity(visualizaranimalesengestacion.getCallingIntent(this, miGranja,4,1));
    }

    public void abrirotros (View v){
        startActivity(visualizaranimalesengestacion.getCallingIntent(this, miGranja,5,1));
    }
    ...
    public static Intent getCallingIntent(Context context, MiGranja miGranja){
        ...
        Intent intent = new Intent(context, seleccionanimaldarbaja.class );
