...
public class anyadiranimalcorral extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_anyadiranimalcorral);
    ...
    public void anyadiranimal(View v) {
        ...
        if (fechanacimiento.getText().equals("") || codigoexplotacion.getText().equals("") || raza.getText().equals("")
            ...
            if(corral.getAnimal().size() == corral.getMaxAnimales()){
                AlertDialog.Builder alerta = new AlertDialog.Builder(this);
                alerta.setTitle("Fallo al añadir un animal");
                alerta.setMessage("El corral está lleno");
                alerta.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                ...
                confirmacion.setPositiveButton("Si", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        miGranja.getCorrales().get(posicionarray).addAnimal(aux);
    ...
    public static Intent getCallingIntent(Context context, MiGranja miGranja, int tipoanimal, Corral corral, int posicionarray) {

        Intent intent = new Intent(context, anyadiranimalcorral.class);
