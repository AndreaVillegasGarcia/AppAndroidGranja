...
public class visualizarcorral extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_visualizarcorral);
        Intent i = getIntent();
        ...
        SwipeAdaptercorral swipeAdapter = new SwipeAdaptercorral(getSupportFragmentManager(),miGranja);
    ...
    public static Intent getCallingIntent(Context context, MiGranja miGranja){
        ...
        Intent intent = new Intent(context, visualizarcorral.class );
