...
public class visualizaranimalesparages extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_visualizaranimalesparages);
        Intent i = getIntent();
        ...
        SwipeAdapterparages swipeAdapter = new SwipeAdapterparages(getSupportFragmentManager(), miGranja, tipoanimal);
    ...
    public static Intent getCallingIntent(Context context, MiGranja miGranja, int tipoanimal){
        ...
        Intent intent = new Intent(context, visualizaranimalesparages.class );
