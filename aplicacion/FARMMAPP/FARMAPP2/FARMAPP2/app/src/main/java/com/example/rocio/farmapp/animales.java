...
public class animales extends AppCompatActivity {
    ...
    public void anyadiranimal(View w){
        ...
        startActivityForResult(seleccionanimal.getCallingIntent(this, miGranja),mRequestCode);
    }

    public void veranimal(View v) {
        startActivityForResult(seleccionanimalver.getCallingIntent(this, miGranja),mRequestCode);
    }
    ...
    public static Intent getCallingIntent(Context context, MiGranja miGranja){
        ...
        Intent intent = new Intent(context, animales.class );
