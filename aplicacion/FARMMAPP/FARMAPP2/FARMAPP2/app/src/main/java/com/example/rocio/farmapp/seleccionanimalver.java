...
public class seleccionanimalver extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seleccionanimalver);
        Intent i = getIntent();
    ...
    public void abrirvaca (View w){
        startActivityForResult(visualizaranimales.getCallingIntent(this, miGranja,0),mRequestCode);
    }

    public void abrircerdo (View w){
        startActivityForResult(visualizaranimales.getCallingIntent(this, miGranja,1),mRequestCode);
    }

    public void abriroveja (View w){
        startActivityForResult(visualizaranimales.getCallingIntent(this, miGranja,3),mRequestCode);
    }

    public void abrirgallina (View w) {
        startActivityForResult(visualizaranimales.getCallingIntent(this, miGranja,2),mRequestCode);
    }

    public void abrircabra (View w){
        startActivityForResult(visualizaranimales.getCallingIntent(this, miGranja,4),mRequestCode);
    }

    public void abrirotros (View v){
        startActivityForResult(visualizaranimales.getCallingIntent(this, miGranja,5),mRequestCode);
    }
    ...
    public static Intent getCallingIntent(Context context, MiGranja miGranja){
        ...
        Intent intent = new Intent(context, seleccionanimalver.class );
