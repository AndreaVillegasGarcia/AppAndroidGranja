...
public class historialanalisisagua extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_historialanalisisagua);
        Intent i = getIntent();
        ...
        lista.setAdapter(new Adaptadoranalisis(this,miGranja,corral,posicionarray));
    ...
    public static Intent getCallingIntent(Context context, MiGranja miGranja, Corral corral, int posicionarray){
        ...
        Intent intent = new Intent(context, historialanalisisagua.class );
