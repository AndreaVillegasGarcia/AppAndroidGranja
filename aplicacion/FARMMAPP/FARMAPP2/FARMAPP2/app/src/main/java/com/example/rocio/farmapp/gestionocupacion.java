...
public class gestionocupacion extends AppCompatActivity {
    ...
    private TextView animalesmax;
    private TextView numanimales;
    private int posicionarray;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_gestionocupacion);
        Intent i = getIntent();
        ...
        animalesmax = (TextView) findViewById(R.id.maxima);
        numanimales = (TextView) findViewById(R.id.actual);

        animalesmax.setText(Integer.toString(corral.getMaxAnimales()));
        numanimales.setText(Integer.toString(corral.getAnimal().size()));
    ...
    public void anyadiranimal(View w){

        startActivityForResult(selecionanimalocupacion.getCallingIntent(this, miGranja,corral,posicionarray), mRequestCode);

    }
    public void eliminaranimal(View w){
        startActivityForResult(visualizaranimalescorral.getCallingIntent(this, miGranja,corral,corral.getAnimal().get(0).getTipoAnimal(),posicionarray,1), mRequestCode);

    }
    public void veranimal(View w){

        startActivityForResult(visualizaranimalescorral.getCallingIntent(this, miGranja,corral,corral.getAnimal().get(0).getTipoAnimal(),posicionarray,0), mRequestCode);
    ...
    public static Intent getCallingIntent(Context context, MiGranja miGranja, Corral corral,int posicionarray){
        ...
        Intent intent = new Intent(context, gestionocupacion.class );
