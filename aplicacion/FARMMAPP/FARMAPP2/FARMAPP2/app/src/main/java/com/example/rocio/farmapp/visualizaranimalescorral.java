...
public class visualizaranimalescorral extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_visualizaranimalescorral);
        Intent i = getIntent();
        ...
        SwipeAdapteranimalescorral swipeAdapter = new SwipeAdapteranimalescorral(getSupportFragmentManager(), miGranja,corral, tipoanimal,posicionarray,opcion);
    ...
    public static Intent getCallingIntent(Context context, MiGranja miGranja,Corral corral, int tipoanimal,int posicionarray,int opcion){

        Intent intent = new Intent(context, visualizaranimalescorral.class );
