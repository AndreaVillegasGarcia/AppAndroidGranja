...
public class historialpienso extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_historialpienso);
        Intent i = getIntent();
        ...
        lista.setAdapter(new Adaptadorpienso(this, miGranja, corral));
    ...
    public static Intent getCallingIntent(Context context, MiGranja miGranja, Corral corral){

        Intent intent = new Intent(context, historialpienso.class );
